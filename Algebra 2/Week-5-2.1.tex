\documentclass[twoside]{article}
    ...
    % & $x or y$ [dl arrow], [dr arrow] join
    % x [dr arrow] && y [dl arrow]
    % & x and y meet

    1) $X set, P(X) = {Y \subset X subset}$ 
   $ X \leq Y \iff Y \subset X$

    % & $x cup y$ [dl arrow], [dr arrow] join
    % x [dr arrow] && y [dl arrow]
    % & x cap y meet
    ...
    % & $x + y$ [dl arrow], [dr arrow] join
    % x [dr arrow] && y [dl arrow]
    % & x cap y meet

    3) $F \subset K$ fields 

    % & $E_3 = field generated$ [dl arrow], [dr arrow] join
    % E1 [dr arrow] && E2 [dl arrow]
    % & E1 cap E2 meet
